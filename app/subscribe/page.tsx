...
const subscribeToPlan = async ({
  ...
  const url = `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/checkout`;
        ...
        {availablePlans.map((plan, key) => (
          ...
          >
            <div className="flex-1">
              ...
              {plan.isPopular && (
                <p className="absolute top-0 py-1.5 px-4 bg-primary/50 text-white rounded-full text-xs font-semibold uppercase tracking-wide transform -translate-y-1/2">
                  Most popular
                </p>
              )}
...
//       {/* Section Header */}
//       <div>
//         <h2 className="text-3xl font-bold text-center mt-5 sm:text-5xl tracking-tight">
//           Pricing
//         </h2>
//         <p className="max-w-3xl mx-auto mt-4 text-xl text-center">
//           Get started on our weekly plan or upgrade to monthly or yearly when
